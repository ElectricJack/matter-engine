...
if(CMAKE_SOURCE_DIR STREQUAL MATTER_REPOSITORY_ROOT)
    ...
    function(matter_assert_viewer_graph)
        ...
        if(NOT headless_core_count EQUAL 134 OR NOT headless_surface_count EQUAL 21)
            message(FATAL_ERROR
        ...
        if(MATTER_EXPECT_RETOPO)
            set(expected_viewer_count 175)
        else()
            set(expected_viewer_count 174)
        endif()
...
message(STATUS "viewer graph preserves isolated 134+21 headless and coherent 174/175-source viewer boundaries")
