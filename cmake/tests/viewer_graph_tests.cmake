...
if(CMAKE_SOURCE_DIR STREQUAL MATTER_REPOSITORY_ROOT)
    ...
    function(matter_assert_viewer_graph)
        ...
        if(NOT headless_core_count EQUAL 131 OR NOT headless_surface_count EQUAL 21)
            message(FATAL_ERROR
        ...
        if(MATTER_EXPECT_RETOPO)
            set(expected_viewer_count 173)
        else()
            set(expected_viewer_count 172)
        endif()
...
message(STATUS "viewer graph preserves isolated 132+21 headless and coherent 172/173-source viewer boundaries")
