...
if(CMAKE_SOURCE_DIR STREQUAL MATTER_REPOSITORY_ROOT)
    ...
    function(matter_assert_viewer_graph)
        ...
        if(NOT headless_core_count EQUAL 121 OR NOT headless_surface_count EQUAL 21)
            message(FATAL_ERROR
...
message(STATUS "viewer graph preserves isolated 121+21 headless and coherent 163/164-source viewer boundaries")
