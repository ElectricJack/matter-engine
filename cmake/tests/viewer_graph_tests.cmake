...
if(CMAKE_SOURCE_DIR STREQUAL MATTER_REPOSITORY_ROOT)
    ...
    function(matter_assert_viewer_graph)
        ...
        if(NOT headless_core_count EQUAL 116 OR NOT headless_surface_count EQUAL 21)
            message(FATAL_ERROR
...
message(STATUS "viewer graph preserves isolated 116+21 headless and coherent 156/157-source viewer boundaries")
