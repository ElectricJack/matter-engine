...
function(matter_apply_test_assertion_policy target)
    if(NOT TARGET "${target}")
        message(FATAL_ERROR "matter_apply_test_assertion_policy: unknown target '${target}'")
    endif()
    target_compile_options("${target}" PRIVATE
        "/FI${CMAKE_CURRENT_FUNCTION_LIST_DIR}/MatterTestAssertions.h")
endfunction()
