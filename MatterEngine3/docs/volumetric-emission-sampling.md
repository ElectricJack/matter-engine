...
`MatterEditor/src/ui.cpp` — Volumetrics panel (insert after "Fog falloff", line 620):
...
make -C MatterEditor windows $TMPARGS
```
...
| `MatterEditor/src/ui.cpp` | 3 controls in Volumetrics panel |
