...
// parent, name, transform, PartInstance, RigidBody, PhysicsVelocity, all four
// colliders (box/sphere/capsule/convex-hull), CharacterController, RiverFloatBody
// and its runtime RiverFloatState.
// Components outside it — SectorStreaming, anything gameplay adds — are not
// restored by stop().
//
