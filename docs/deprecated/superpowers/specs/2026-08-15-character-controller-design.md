...
> Deprecated during the 2026-08-30 main integration. The per-streamed-sector
> collision and editor-owned controller proposal below is superseded by the
> [engine-wide terrain collision design](../../../completed/superpowers/specs/2026-08-24-engine-wide-terrain-collision-design.md)
> and [accepted river character integration](../../../completed/superpowers/specs/2026-08-30-river-character-controller-integration-design.md).
> Original implementation-status statements and API claims are historical,
> not current requirements. Preserved for later reference audit/removal.
