#!/bin/bash
# Run script for OpenParticleSurfaceLib

set -e  # Exit on any error

echo "Running OpenParticleSurfaceLib..."
...
EXECUTABLE="./build/$PLATFORM/open_particle_surface"
...
if [ -f "$EXECUTABLE" ]; then
    ...
    EXECUTABLE="./open_particle_surface"
