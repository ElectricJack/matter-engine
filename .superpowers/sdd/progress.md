...
Task 6: performance gate implemented; StressForest50k parity measurement blocked by pre-sampling renderer failure
  ...
  - Sampling-path smoke: CornellBox, warmup 0s/sample 1s: 60 frames, median 559.299745 FPS, p95 2.016100 ms, static vertex/cluster/stable instance/immediate-submit deltas all 0, validation errors 0.
