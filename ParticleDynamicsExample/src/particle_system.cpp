...
void ParticleSystem::cleanup() {
    ...
    // Clear per-particle gamified arrays (must stay size-synced with the main SoA arrays)
    heat_energy_.clear();
    ...
    // Clear relationship lists (their particle indices become invalid after reset)
